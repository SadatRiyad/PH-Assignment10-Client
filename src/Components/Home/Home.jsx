                    ...
                    <div data-aos="zoom-in" data-aos-duration="1000" className="hero a1 min-h-screen">
                        ...
                        <div className="hero-content text-center text-neutral-content">
                            <div className="px-8" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000" >
                                ...
                                <a href='#craftItems' className="btn bg-red hover:bg-red border-red text-white hover:text-white rounded hover:border-red  hover:-translate-y-1 transition-all duration-200 font-bold mt-6">Explore Now</a>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
                    ...
                    <div className="hero a2 min-h-screen">
                        <div className="hero-content text-left text-white shadow-lg hero-overlay bg-opacity-30  md:bg-opacity-15 relative">
                            <div className="px-8">
                                ...
                                <a href='#craftItems' className="btn absolute bg-red hover:bg-red border-red text-white hover:text-white rounded hover:border-red  hover:-translate-y-1 transition-all duration-200 font-bold -mt-8 md:mt-0">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
                    ...
                    <div className="hero a3 min-h-screen">
                        ...
                        <div className="hero-content text-center text-neutral-content">
                            <div className="px-8">
                                ...
                                <a href='#craftItems' className="btn bg-red hover:bg-red border-red text-white hover:text-white rounded hover:border-red  hover:-translate-y-1 transition-all duration-200 font-bold mt-6">Discover More</a>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
