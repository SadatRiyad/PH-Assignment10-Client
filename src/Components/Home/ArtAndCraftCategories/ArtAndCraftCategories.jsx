        ...
        <div>
            <div className="pt-12" id="">
                <div data-aos="zoom-in" data-aos-duration="1500" data-aos-anchor-placement="top-center" data-aos-delay="250" className="pt-16 pb-4 mb-12 mx-4 bg-color2 rounded-2xl">
                    <h2 data-aos="zoom-in" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" data-aos-delay="0" className="text-3xl md:text-5xl text-center text-blue font-bold mb-4">Art {' '}
                        <span style={{ fontWeight: 'bold' }}>
                            {/* Style will be inherited from the parent element */}
                            <Typewriter
                                words={['& Craft Items Categories..', 'Sub-Categories..', '& Craft Categories..']}
                                cursor
                                cursorStyle='.'
                                typeSpeed={70}
                                deleteSpeed={50}
